...
const header1 = React.createElement(
  "h1",
  { id: "header1", media: "mobile", key: 0 },
  "this is header1 tag",
);
const header2 = React.createElement(
  "h1",
  { id: "header2", media: "mobile", key: 1 },
  "this is header2 tag",
);
const headersParent = React.createElement(
  "div",
  { id: "header's parent" },
  [header1, header2],
  //   .map((el, index) => {   // adding key post creating react elements is not actually adding the keys
  //     el.key = index;
  //     return el;
  //   }),
);
const headersParentsParent = React.createElement(
  "div",
  { id: "header's parent's parent" },
  headersParent,
);
